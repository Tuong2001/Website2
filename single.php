		...
		<div class="container">
			<div class="header">
				...
				<li class="grid"><a href="products.php">Men</a>
						...
						<li class="grid"><a href="?page=category_management">Admin</a>
						</li>
						<li class="grid"><a href="?page=product_management">Contact</a>
						</li>
				</div>
				<div class="clearfix"> </div>
			</div>
					...
					<div class="col-md-7 single-top-right">
						...
						<h2>Lorem Ipsum</h2>
							...
							<ul class="tag-men">
								...
								<a href="checkout.php" class="add-cart item_add">ADD TO CART</a>
