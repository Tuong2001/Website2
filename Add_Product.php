...
<?php
	if(isset($_POST["btnAdd"]))
	{
		...
		if(trim($id)=="")
		{
			$err .= "<li>Enter product ID, Pleases</li>"; 
		}
		if(trim($proname)=="")
		{
			$err .= "<li>Enter product name, Pleases</li>"; 
		}
		if($category=="0")
		{
			$err .= "<li>Choose product category, Pleases</li>"; 
		}
		if(!is_numeric($price))
		{
		...
		else
		{
			if($pic ['type'] == "image/jpg" ||$pic ['type'] =="image/jpeg" || $pic ['type']=="image/png" || $pic['type']=="image/gif")
			{
				if($pic['size'] <=614400)
				{
					...
					{
						echo "<li>Duplucate product ID or Name</li>";
					}
				}
				else
				{
					echo "Size f image too big";
				}
			}
			else
			{
